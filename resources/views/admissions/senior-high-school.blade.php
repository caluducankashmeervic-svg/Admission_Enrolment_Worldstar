...
<div class="max-w-4xl mx-auto bg-white border border-slate-200 rounded-lg shadow-sm p-5 md:p-8 mt-4 md:mt-6">
    ...
    <div class="space-y-5 text-slate-700">
        <div class="p-4 border border-slate-200 rounded-lg">
            <h2 class="font-semibold text-base md:text-lg text-slate-800">STEM (Science, Technology, Engineering, and Mathematics)</h2>
            <p class="mt-1 text-sm">For students aiming for science, engineering, medicine, and technology-related college programs.</p>
        </div>
        <div class="p-4 border border-slate-200 rounded-lg">
            <h2 class="font-semibold text-base md:text-lg text-slate-800">ABM (Accountancy, Business, and Management)</h2>
            <p class="mt-1 text-sm">For students preparing for business, entrepreneurship, accountancy, and management courses.</p>
        </div>
        <div class="p-4 border border-slate-200 rounded-lg">
            <h2 class="font-semibold text-base md:text-lg text-slate-800">HUMSS (Humanities and Social Sciences)</h2>
            <p class="mt-1 text-sm">For students interested in communication, public service, law, education, and social studies.</p>
        </div>
        <div class="p-4 border border-slate-200 rounded-lg">
            <h2 class="font-semibold text-base md:text-lg text-slate-800">GAS (General Academic Strand)</h2>
