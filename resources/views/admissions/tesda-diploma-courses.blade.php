...
<div class="max-w-4xl mx-auto bg-white border border-slate-200 rounded-lg shadow-sm p-8 mt-6">
    <div class="border-l-4 border-amber-400 pl-4 mb-6">
        <h1 class="text-3xl font-bold text-[#1D4ED8] tracking-wide">TESDA Diploma Courses</h1>
    ...
    <div class="space-y-5 text-slate-700">
        <div class="p-4 border border-slate-200 rounded-lg">
            <h2 class="font-semibold text-lg text-slate-800">CST (Computer Science Technology)</h2>
            <p class="mt-1 text-sm">Focuses on software fundamentals, system analysis, and practical coding skills.</p>
        </div>
        <div class="p-4 border border-slate-200 rounded-lg">
            <h2 class="font-semibold text-lg text-slate-800">CET (Computer Engineering Technology)</h2>
            <p class="mt-1 text-sm">Covers hardware servicing, computer architecture, and system integration.</p>
        </div>
        <div class="p-4 border border-slate-200 rounded-lg">
            <h2 class="font-semibold text-lg text-slate-800">EET (Electronics Engineering Technology)</h2>
            <p class="mt-1 text-sm">Builds competencies in electronics, instrumentation, and troubleshooting.</p>
        </div>
        <div class="p-4 border border-slate-200 rounded-lg">
            <h2 class="font-semibold text-lg text-slate-800">ICT (Information and Communications Technology)</h2>
