...
<div class="max-w-4xl mx-auto bg-white border border-slate-200 rounded-lg shadow-sm p-5 md:p-8 mt-4 md:mt-6">
    <div class="border-l-4 border-amber-400 pl-3 md:pl-4 mb-6">
        <h1 class="text-2xl md:text-3xl font-bold text-[#1D4ED8] tracking-wide">Apply as Working Student</h1>
        <p class="text-sm text-slate-500 mt-1">Support options, application process, and requirements for working students.</p>
    </div>

    <section class="mb-8">
        <h2 class="text-lg md:text-xl font-semibold text-slate-800 mb-3">Available Support</h2>
    ...
    <section class="mb-8">
        ...
        <ol class="list-decimal list-inside space-y-1 text-slate-700 text-sm">
            ...
            <li>Attend academic advising for section and class-load assessment.</li>
            <li>Finalize enrollment after your working-student request is approved.</li>
        </ol>
    </section>
    ...
    <section>
        ...
        <ul class="list-disc list-inside space-y-1 text-slate-700 text-sm">
            ...
            <li>Completed Working Student Request/Application Form</li>
